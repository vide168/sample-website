        ...
        f.ensureModuleRegistered("SignalsFBEventsCCRuleEvaluatorConfigTypedef", function () {
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    a.coerce;
                    a = b.objectWithFields({
                        ccRules: b.allowNull(b.arrayOf(b.objectWithFields({
                            id: b.number(),
                            rule: b.objectOrString()
                        }))),
                        wcaRules: b.allowNull(b.arrayOf(b.objectWithFields({
                            id: b.number(),
                            rule: b.objectOrString()
                        }))),
            ...
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    function A(b) {
                        ...
                        f != null && v(f, function (a) {
                            a != null && v(w(a), function (c) {
                                b.customParams = b.customParams || new l(),
            ...
            return function (a, b, c, d) {
                ...
                (function () {
                    ...
                    function ma(a) {
                        ...
                        switch (a) {
                            ...
                            case "openbridge":
                                var G = c[0]
                                    , H = c[1];
                                G !== null && H !== null && typeof G === "string" && typeof H === "string" && (W.callMethod(["optIn", G, "OpenBridge"]),
                    ...
                    function Z(a, b, c) {
                        ...
                        if (S.call(U, d)) {
                            b != null && D(U[d].userData) ? (U[d].userData = e ? b || {} : {},
                                X.loadPlugin("identity")) : N({
                                    pixelID: d,
                    ...
                    function qa(a, b, c) {
                        for (var d = 0, e = T.length; d < e; d++) {
                            var f = T[d];
                            if (!(a === "PageView" && this.allowDuplicatePageViews) && Object.prototype.hasOwnProperty.call(V, a) && V[a].has(f.id))
                                continue;
